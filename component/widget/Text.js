...
export const Tip = ({style, ...props}) => {
  return <Text style = {[styles.tip ,style]} {...props} />
}

// export function HeadingBig({style, ...props}): ReactElement {
//   return <Text style = {[styles.h0 ,style]} {...props} />
// }
//
// export function Heading1({style, ...props}): ReactElement {
//   return <Text style = {[styles.h1 ,style]} {...props} />
// }

// export function Heading2({style, ...props}): ReactElement {
//   return <Text style = {[styles.h2 ,style]} {...props} />
// }
//
// export function Paragraph({style, ...props}): ReactElement {
//   return <Text style = {[styles.p ,style]} {...props} />
// }

// export function Tip({style, ...props}): ReactElement {
//   return <Text style = {[styles.tip ,style]} {...props} />
// }
